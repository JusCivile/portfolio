...
export const StaggeredMenu: React.FC<StaggeredMenuProps> = ({
  ...
  className,
  logoUrl = "/public/assets/JusCivileLogo.jpeg",
  menuButtonColor = "#fff",
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div
            className="sm-logo flex gap-2 items-center select-none pointer-events-auto"
            aria-label="Logo"
          >
            <img
              ...
              height={24}
            />
            <p className="sm-logo-text text-white text-xl font-medium">Jus Civile</p>
          </div>
